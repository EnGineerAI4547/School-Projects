...
int main() {
    ...
    printf("Schoolbook runs complete\n");
    ...
    printf("Karatsuba runs complete\n");
    ...
    FILE *fbank = fopen("assign2_bank","r"); 

    if (fbank == NULL) {
        printf("'assign2_bank' file is missing. Please copy it to the same directory as where you execute the code.\n");
        return 1;
    }
